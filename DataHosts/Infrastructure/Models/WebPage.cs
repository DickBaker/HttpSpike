namespace Infrastructure.Models
{
    ...
    public class WebPage : IEquatable<WebPage>
    {
        ...
        public string DraftFilespec             // filename.extn ONLY (no dev/folder path)
        {
            ...
            set
            {
                _draftFilespec = Utils.TrimOrNull(Utils.FileExtnFix(value)); // strip off any device/folder part and remove any dodgy chars
                DraftExtn = Path.GetExtension(_draftFilespec);
            }
        }
        ...
        public string Filespec
        {
            ...
            {
                filespec = value;
                FinalExtn = Path.GetExtension(filespec);
            }
        }
